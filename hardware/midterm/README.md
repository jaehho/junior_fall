...
Write a report for the implementation of a pipelined MIPS processor

- Provide an overview of MIPS and ARM based processors.
  - Discuss: architectural fundamentals, functional blocks, performance, and applications.  
- Explain the implemented MIPS Processor
  - Explain the functional blocks: Program Counter, Instruction memory, Control, Registers, ALU, and data memory.
  - List the core instructions that can be performed.
  - Explain the testbench
    - Analyze and compare synthesized/implemented results with simulation results
    - Include Waveforms and Timing Summaries
  - Discuss FPGA utilization
  - Discuss Pipelining implementation
