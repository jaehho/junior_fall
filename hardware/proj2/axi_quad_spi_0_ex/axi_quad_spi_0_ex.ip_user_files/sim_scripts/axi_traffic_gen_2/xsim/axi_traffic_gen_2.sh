...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_15 -L blk_mem_gen_v8_4_8 -L lib_bmg_v1_0_17 -L lib_cdc_v1_0_3 -L axi_traffic_gen_v3_0_18 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_traffic_gen_2 xil_defaultlib.axi_traffic_gen_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_traffic_gen_2 -key {Behavioral:sim_1:Functional:axi_traffic_gen_2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_traffic_gen_2.wdb xsim.dir libdpi.so)
