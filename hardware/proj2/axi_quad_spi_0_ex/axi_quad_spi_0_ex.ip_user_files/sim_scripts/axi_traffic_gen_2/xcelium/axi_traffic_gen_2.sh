...
#
# Script generated by Vivado on Tue Nov 19 13:34:50 -0500 2024
# SW Build 5164865 on Thu Sep  5 14:37:11 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_traffic_gen_2.sh
...
#
# Usage        : axi_traffic_gen_2.sh
#                axi_traffic_gen_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_traffic_gen_2.sh [-reset_run]
#                axi_traffic_gen_2.sh [-reset_log]
#                axi_traffic_gen_2.sh [-help]
#
...
#                script (type 'axi_traffic_gen_2.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname dist_mem_gen_v8_0_15 -libname blk_mem_gen_v8_4_8 -libname lib_bmg_v1_0_17 -libname lib_cdc_v1_0_3 -libname axi_traffic_gen_v3_0_18 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm dist_mem_gen_v8_0_15 blk_mem_gen_v8_4_8 lib_bmg_v1_0_17 lib_cdc_v1_0_3 axi_traffic_gen_v3_0_18 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_traffic_gen_2.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_traffic_gen_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/src/verilog" \
  ...
  xmvlog -work dist_mem_gen_v8_0_15 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" \
  "../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" \
  ...
  xmvhdl -work axi_traffic_gen_v3_0_18 $xmvhdl_opts \
  "../../../ipstatic/hdl/axi_traffic_gen_v3_0_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvlog -work axi_traffic_gen_v3_0_18 $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" \
  "../../../ipstatic/hdl/axi_traffic_gen_v3_0_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl/src/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_traffic_gen_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_traffic_gen_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_traffic_gen_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_traffic_gen_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_traffic_gen_2.sh [-help]\n\
Usage: axi_traffic_gen_2.sh [-step]\n\
Usage: axi_traffic_gen_2.sh [-lib_map_path]\n\
Usage: axi_traffic_gen_2.sh [-reset_run]\n\
Usage: axi_traffic_gen_2.sh [-reset_log]\n\
Usage: axi_traffic_gen_2.sh [-keep_index]\n\
Usage: axi_traffic_gen_2.sh [-noclean_files]\n\n\
