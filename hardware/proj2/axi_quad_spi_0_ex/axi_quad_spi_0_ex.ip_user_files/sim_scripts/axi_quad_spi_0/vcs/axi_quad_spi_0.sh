...
design_libs=(xpm dist_mem_gen_v8_0_15 lib_pkg_v1_0_4 lib_cdc_v1_0_3 lib_srl_fifo_v1_0_4 fifo_generator_v13_2_10 lib_fifo_v1_0_19 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_quad_spi_v3_2_31 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work axi_quad_spi_v3_2_31 $vhdlan_opts \
...
reset_run()
{
  files_to_remove=(ucli.key axi_quad_spi_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_quad_spi_0_simv.daidir vcs_lib c.obj)
