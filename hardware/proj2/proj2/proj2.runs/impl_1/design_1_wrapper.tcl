...
set rc [catch {
  ...
  update_ip_catalog
  set_property ip_output_repo /afs/ee.cooper.edu/user/j/jaeho.cho/proj2/proj2.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet /afs/ee.cooper.edu/user/j/jaeho.cho/proj2/proj2.runs/synth_1/design_1_wrapper.dcp
