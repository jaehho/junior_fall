...
#
# Script generated by Vivado on Tue Nov 12 17:30:42 -0500 2024
...
#
# Usage        : axi_quad_spi_0.sh
#                axi_quad_spi_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_quad_spi_0.sh [-reset_run]
#                axi_quad_spi_0.sh [-reset_log]
#                axi_quad_spi_0.sh [-help]
#
...
#                script (type 'axi_quad_spi_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname dist_mem_gen_v8_0_15 -libname lib_pkg_v1_0_4 -libname lib_cdc_v1_0_3 -libname lib_srl_fifo_v1_0_4 -libname fifo_generator_v13_2_10 -libname lib_fifo_v1_0_19 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_5 -libname axi_quad_spi_v3_2_31 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm dist_mem_gen_v8_0_15 lib_pkg_v1_0_4 lib_cdc_v1_0_3 lib_srl_fifo_v1_0_4 fifo_generator_v13_2_10 lib_fifo_v1_0_19 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_quad_spi_v3_2_31 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_quad_spi_0.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_quad_spi_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work axi_quad_spi_v3_2_31 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_quad_spi_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_quad_spi_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_quad_spi_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: axi_quad_spi_0.sh [-step]\n\
Usage: axi_quad_spi_0.sh [-lib_map_path]\n\
Usage: axi_quad_spi_0.sh [-reset_run]\n\
Usage: axi_quad_spi_0.sh [-reset_log]\n\
Usage: axi_quad_spi_0.sh [-keep_index]\n\
