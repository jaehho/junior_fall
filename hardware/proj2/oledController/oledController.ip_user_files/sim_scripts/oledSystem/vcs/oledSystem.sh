...
#
# Script generated by Vivado on Tue Nov 19 18:56:12 -0500 2024
# SW Build 5164865 on Thu Sep  5 14:37:11 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : oledSystem.sh
...
#
# Usage        : oledSystem.sh
#                oledSystem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                oledSystem.sh [-reset_run]
#                oledSystem.sh [-reset_log]
#                oledSystem.sh [-help]
#
...
#                script (type 'oledSystem.sh -help' for more information).
#
...
# script info
echo -e "oledSystem.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./oledSystem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_18 $vlogan_opts -sverilog +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/1f8d/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_20 $vlogan_opts -sverilog +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/2ccb/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/676c/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/ec67/hdl" +incdir+"../../../../oledController.gen/sources_1/bd/oledSystem/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.oledSystem xil_defaultlib.glbl -o oledSystem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./oledSystem_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key oledSystem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc oledSystem_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./oledSystem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: oledSystem.sh [-help]\n\
Usage: oledSystem.sh [-step]\n\
Usage: oledSystem.sh [-lib_map_path]\n\
Usage: oledSystem.sh [-reset_run]\n\
Usage: oledSystem.sh [-reset_log]\n\
Usage: oledSystem.sh [-keep_index]\n\
Usage: oledSystem.sh [-noclean_files]\n\n\
