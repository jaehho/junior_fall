...
HD_PWD='C:/Users/jaeho/junior_fall/hardware/proj2/oledController/oledController.runs/oledSystem_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oledSystem_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oledSystem_auto_pc_0.tcl
