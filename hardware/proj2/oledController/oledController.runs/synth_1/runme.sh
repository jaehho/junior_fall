...
HD_PWD='C:/Users/jaeho/junior_fall/hardware/proj2/oledController/oledController.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oledSystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oledSystem_wrapper.tcl
