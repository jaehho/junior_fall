...
HD_PWD='C:/Users/jaeho/junior_fall/hardware/proj2/oledController/oledController.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oledSystem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oledSystem_wrapper.tcl -notrace
