...
#
# Script generated by Vivado on Tue Dec 10 19:12:49 -0500 2024
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_18 -libname processing_system7_vip_v1_0_20 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_18 processing_system7_vip_v1_0_20 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "system.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_18 $xmvlog_opts -sv +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../proj3.gen/sources_1/bd/system/ipshared/1f8d/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_20 $xmvlog_opts -sv +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../proj3.gen/sources_1/bd/system/ipshared/d47c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../proj3.gen/sources_1/bd/system/ipshared/d47c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
